...
static int bp_ssb_bustype_ssb_device_remove(struct device *dev){
...
static int bp_ssb_bustype_ssb_device_uevent(struct device *dev,
					    struct kobj_uevent_env *env){
	return ssb_device_uevent(dev, env);
}
#endif
...
#else
	.remove = bp_ssb_bustype_ssb_device_remove,
#endif
...
#else
	.uevent = bp_ssb_bustype_ssb_device_uevent,
#endif
