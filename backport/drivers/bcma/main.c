...
static int bp_bcma_bus_type_bcma_device_remove(struct device *dev){
...
static int bp_bcma_bus_type_bcma_device_uevent(struct device *dev,
					       struct kobj_uevent_env *env){
	return bcma_device_uevent(dev, env);
}
#endif
...
#else
	.remove = bp_bcma_bus_type_bcma_device_remove,
#endif
	
#if LINUX_VERSION_IS_GEQ(6,3,0)
	.uevent		= bcma_device_uevent,
#else
	.uevent = bp_bcma_bus_type_bcma_device_uevent,
#endif
