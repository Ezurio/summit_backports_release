...
ATTRIBUTE_GROUPS_BACKPORT(mhi_dev);
#endif
#else
#define BP_ATTR_GRP_STRUCT device_attribute
ATTRIBUTE_GROUPS_BACKPORT(mhi_dev);
...
static int bp_mhi_bus_type_mhi_uevent(struct device *dev,
				      struct kobj_uevent_env *env){
	return mhi_uevent(dev, env);
}
#endif
...
struct bus_type mhi_bus_type = {
	...
	.uevent = mhi_uevent,
#else
	.uevent = bp_mhi_bus_type_mhi_uevent,
#endif
