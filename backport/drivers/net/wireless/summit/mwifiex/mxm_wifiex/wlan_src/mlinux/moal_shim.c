				 ...
				 t_u32 *pshort_ssid)
{
 ...
 t_u16 moal_read_unaligned_u16(const void *src)
{
 ...
 t_u32 moal_read_unaligned_u32(const void *src)
{
#if defined(CONFIG_HAVE_EFFICIENT_UNALIGNED_ACCESS)
 ...
 void moal_write_unaligned_u16(void *dest, t_u16 val)
{
#if defined(CONFIG_HAVE_EFFICIENT_UNALIGNED_ACCESS)
	*((t_u16 *)dest) = val;
#else
 ...
 void moal_write_unaligned_u32(void *dest, t_u32 val)
{
#if defined(CONFIG_HAVE_EFFICIENT_UNALIGNED_ACCESS)
	*((t_u32 *)dest) = val;
#else
