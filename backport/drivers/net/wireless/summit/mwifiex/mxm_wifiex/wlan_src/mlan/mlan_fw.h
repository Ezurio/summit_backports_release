...
/* Vndr MFG Comamnds: HostCmd_VNDR_MFG_CMD*/
typedef MLAN_PACK_START struct _HostCmd_VNDR_MFG_CMD {
	t_u32 oid;
	t_u8  data[];
} MLAN_PACK_END HostCmd_VNDR_MFG_CMD;
...
typedef struct MLAN_PACK_START _HostCmd_DS_COMMAND {
	...
	union {
		...
		HostCmd_VNDR_MFG_CMD host_vndr_mfg;
	} params;
