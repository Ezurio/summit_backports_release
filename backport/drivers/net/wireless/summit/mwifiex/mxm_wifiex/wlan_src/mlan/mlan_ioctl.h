...
enum _mlan_ioctl_req_id {
...
#ifdef UAP_SUPPORT
	MLAN_OID_11D_BCN_COUNTRY_IE_INFO = 0x000D0005,
#endif
	...
	MLAN_OID_FILS_IP_CFG = 0x00200035,
	...
	MLAN_OID_SCAN_6G_CONFIG = 0x0020008E,
	...
	MLAN_OID_UAP_6E_INBAND_FRAME = 0x00200096,
	...
	/* Vendor Comamnds Group */
	MLAN_IOCTL_VNDR = 0x10000000,
	MLAN_OID_VNDR_MFG_START = 0x10000001,
	MLAN_OID_VNDR_MFG_WRITE = 0x10000002,
	MLAN_OID_VNDR_MFG_STOP  = 0x10000003,
};
...
/** Type definition of _mlan_scan_6g_cfg */
typedef struct _mlan_scan_6g_cfg {
	/** scan 6 GHz channels flag:
	 * 0: scan all 6 GHz channels,
	 * 1: scan colocated AP channels or/and PSC channels
	 */
	t_u8 scan_coloc_ap;
} mlan_scan_6g_cfg, *pmlan_scan_6g_cfg;
...
/** 6E inband frame configuration parameters */
typedef struct inband_6e_frames_cmd_t {
	/** type*/
	t_u16 type;
	/** length of TLV */
	t_u16 len;
...
typedef struct _mlan_ds_bss {
	...
	union {
		...
		inband_6e_frames_cmd_t inband_6e_frame;
...
#define MLAN_ACT_SET_6G_CFP_TBL 0x7
...
typedef struct _mlan_ds_custom_reg_domain {
	...
	t_u8 num_a_chan;
	/** num of 6g channels in custom_reg_domain */
	t_u8 num_6g_chan;
	/** cfp table */
...
/** Type definition of mlan_6g_cap_t */
typedef struct _mlan_6g_cap_t {
	/** Minimum MPDU Start Spacing */
	t_u16 min_mpdu_start_spacing : 3;
	/** Max A-MPDU length Exponent */
	t_u16 max_ampdu_length_exp : 3;
	/** Max MPDU length */
	t_u16 max_mpdu_length : 2;
	/** reserved1 */
	t_u16 rsvd1 : 1;
	/** SM PowerSave */
	t_u16 sm_power_save : 2;
	/** RD Responder */
	t_u16 rd_responder : 1;
...
/** Type definition of mlan_ds_11ax_6g_capa for MLAN_OID_11AX_6G_CFG */
typedef MLAN_PACK_START struct _mlan_ds_11ax_he_6g_capa {
	/** tlv id of he capability */
	t_u16 id;
	/** length of the payload */
	t_u16 len;
	...
	/** capability info */
	t_u16 capa;
} MLAN_PACK_END mlan_ds_11ax_he_6g_capa, *pmlan_ds_11ax_he_6g_capa;
...
typedef struct _mlan_ds_misc_cfg {
	...
	union {
		...
		/** Get associate info for MLAN_OID_MISC_PREV_ASSOC_INFO */
...
/*-----------------------------------------------------------------*/
/** Vendor Commands Group */
/*-----------------------------------------------------------------*/
/** Type definition of mlan_vndr_mfg_start for MLAN_OID_VNDR_MFG_START*/
typedef MLAN_PACK_START struct _mlan_vndr_mfg_start {
	t_u8 data[4];
} MLAN_PACK_END mlan_vndr_mfg_start, *pmlan_vndr_mfg_start;

/** Type definition of mlan_vndr_mfg_write for MLAN_OID_VNDR_MFG_WRITE*/
typedef MLAN_PACK_START struct _mlan_vndr_mfg_write {
	t_u32 data_len;
	t_u8  data[];
} MLAN_PACK_END mlan_vndr_mfg_write, *pmlan_vndr_mfg_write;

/** Type definition of mlan_vndr_cmd for MLAN_IOCTL_VNDR */
typedef MLAN_PACK_START struct _mlan_vndr_cmd {
	/** Sub-command */
	t_u32 sub_command;

	union {
		mlan_vndr_mfg_start mfg_start;
		mlan_vndr_mfg_write mfg_write;
	} param;
} MLAN_PACK_END  mlan_vndr_cmd, *pmlan_vndr_cmd;
