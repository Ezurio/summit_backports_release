...
#define LRD_DESC         "Summit 60 Series Wireless Network Driver"
#define LRD_AUTHOR       "Summit"
#define LRD_BLD_VERSION  "12.103.8.3"
...
struct mwl_rx_desc {
	...
	u8 reserved[2];
	u8 payldType;
	s8 rssi;                     /* received signal strength indication */
...
extern struct ieee80211_ops mwl_mac80211_ops;
